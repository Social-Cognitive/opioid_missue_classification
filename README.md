...
### Machine learning models for traditional classification
```python
# models
...
target_classes = [0,1]
def performance(model, X_train_vect,X_test_vect,Y_train,Y_test,model_name):
...
def word_cloud(data,classno):
  ...
  plt.savefig('wordcloud for class '+str(classno)+'.jpg')
...
```
![](Unstructured%20Data%20Classification%20and%20Realtion%20Findings/Images/Attention%20performance.png)
